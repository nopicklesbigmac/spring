...
<link href="css/my_movie_story.css?aa" rel='stylesheet' type='text/css'>
<meta charset="UTF-8">
...
<body>
	...
	<div class="page-util">
		<div class="inner-wrap">
			<div class="location">
				...
				<a href="my_movie_story.jsp" title="페이지 이동">
					나의 무비스토리
				</a>
			</div>
		</div>
	...
	<div class="inner-wrap">
    <div class="inb-area">
    	<a class="tit" href="https://www.megabox.co.kr/mypage">
    		나의 메가박스
    	</a>
    	<a class="area-a" href="https://www.megabox.co.kr/mypage/bookinglist">
    		예매/구매내역
    	</a>
    	<a class="area-a">
    		영화/스토어 관람권	
	...
	<div class="contents">
		<h2 class="movie-tit">나의 무비스토리</h2>
		<div class="tap-block">
			<div class="btn ">
				<a href="#">무비타임라인</a>
			</div>
		...
		<!-----------------------------  무비 타임라인   ------------------------->
		<!-- <div class="btn-list">
			<button type="button" class="left-swiper-btn">
			</button>
			<button type="button" class="date-btn">
				2021
			</button>
			<button type="button" class="right-swiper-btn">
			</button>
		</div>
		<div class="movie-timeline">
			<strong>나의 무비타임라인을 만들어 보세요.</strong>
		</div> -->
		<!-- --------------------------  무비 포스트  ---------------------------->
		<!-- <div class="tab-sorting">
			<button class="tab-btn on" type="button" style="left:300px; float:left;">
			나의 포스트 
			</button>
			<button class="tab-btn" type="button" style="left:300px; float:left;">구독중인 포스트</button>
		</div>
		<div class="movie-list">
			...
			<div class="input-box">
				<input class="input-text" type="text" title="제목, 장르, 감독, 주연배우" placeholder="제목, 장르, 감독, 주연배우">
		...
		<div class="movie-post">
			<strong>등록된 무비포스트가 없습니다.</strong>
		</div>-->
			<!---------------------------관람평  ----------------------------- -->
		<!-- <div class="board-list-movie-story">
		<p class="result-count">
			<strong>
			총
			<b class="font-gblue">0</b>
		...
		<div class="no-result">등록된 한줄평이 없습니다.
		</div> -->
		<!--------------------------- 본영화  ----------------------------- -->
		<!-- <div class="mypage-info">
			...
			<a href="#" class="btn-model-open" title="본 영화 등록">본 영화 등록</a>
		</div>
		<div class="board-list-movie-story">
		<p class="result-count">
			<strong>
		...
		<div class="no-result">관람 내역이 없습니다.
		</div> -->
		<!--------------------------- 보고싶어  ----------------------------- -->
