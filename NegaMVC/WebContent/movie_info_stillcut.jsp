...
<link href='css/movie_info.css?aa' rel='stylesheet' type='text/css'>
<meta charset="UTF-8">
...
<div class="inner-wrap">
	...
	<div class="stillcut-slide" id="tab1">
		<div class="slide-title">
			...
			<div class="slide-btn">
				<a href="#" title="이전영상" class="videoBtn btn-prev swiper-button-prev swiper-buttton-disabled">
					<i class="iconset ico-prev-circle"></i>
						<span>이전 영상</span>
				</a>
				<a href="#" title="다음영상" class="videoBtn btn-next swiper-button-next">
					<i class="iconset ico-next-circle"></i>
						<span>다음 영상</span>
				</a>
			</div>
			<div class="swiper-container gallery-top">
				<video controls>
					<source src="video/2fe19664df4cd1b4f5f43a2f790c3718_W.mp4" type="video/mp4"></source>
				</video>
			</div>
			<div class="thum-wrap">
				<div class="a-c mt40 thum-caption2"></div>
				<div class="btn-more caption-btn">
					<button class="btn" type="button">
						<span class="txt">자막보기</span>
						<i class="iconset ico-btn-more-arr" style="transform: rotate(0deg);"></i>
					</button>
				</div>
			</div>
			<div class="thumbs-wrap">
				<div class="swiper-container gallery-thumbs">
					<div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
						<div class="thumbsbtn swiper-slide swiper-slide-active swiper-silide-thumb-active" style="width: 240px; margin-right: 20px;">
							<img src="image/movie_info/SRRPh0kbqEGbHAFf4m72gRGigZwLajkA_380.jpg" class="thumbs-img-btn">
							<div class="movie-detail">티저 예고편</div>
							<i class="iconset ico-play"></i>
						</div>
						<div class="thumbsbtn swiper-slide swiper-slide-next" style="width: 240px; margin-right: 20px;">
							<img src="image/movie_info/wM1Zha2HFnCUd3qIxqcDTP7PBPZkX5qW_380.jpg" class="thumbs-img-btn">
							<div class="movie-detail">2차 예고편</div>
							<i class="iconset ico-play"></i>
						</div>
					</div>
				</div>
				<div class="slide-btn thumb-btn">
					<a href="" class="videoBtn btn-prev swiper-button-prev swiper-button-disabled">
						<img src="image/movie_info/btn-prev.png"/>
					</a>
					<a href="" class="videoBtn btn-next swiper-button-next">
						<img src="image/movie_info/btn-next.png"/>
					</a>
				</div>
			</div>
		</div>
	...
	<div class="stair-slide">
		<h2 class="tit small">
			스파이더맨 : 노 웨이 홈에 대한
			<span class="font-gblue">16</span>
			개의 스틸컷이 있어요!
		</h2>
		<div class="stair-slide-list" style="height: 1207px;"> 
			<div class="thumb" style="display: block; opacity: 1; transform: translate(0px, 0px); transition: transform 0s ease 0s, opacity 0.2s ease-out 0.2s;">
				<a href="#" title="스틸컷 보기">
					<img src="image/movie_info/iec4gByIz1OuAACskdZ0t4i4PfglBgK6_420.jpg">
				</a>
			</div>
			<div class="thumb" style="display: block; opacity: 1; transform: translate(280px, 0px); transition: transform 0s ease 0s, opacity 0.2s ease-out 0.2s;">
				<a href="#" title="스틸컷 보기">
					<img src="image/movie_info/thewarofflowerPoster.jpg">
				</a>
			</div>
			<div class="thumb" style="display: block; opacity: 1; transform: translate(560px, 0px); transition: transform 0s ease 0s, opacity 0.2s ease-out 0.2s;">
				<a href="#" title="스틸컷 보기">
					<img src="image/movie_info/OkLgi2wVn86SUumVeIoQyeHYepN2JJ8Q_380.jpg">
				</a>
			</div>
		</div>
	</div>
