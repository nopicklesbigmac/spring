...
<div class="inner-wrap">
	<div class="tab-list fixed">
		<ul>
			<li>
				<a href="Controller?command=movieInfo" title="주요정보 탭으로 이동">주요정보</a>
			</li>
			<li class="on">
	...
	<div class="tit-util mt40 oneContent">
		...
		<div class="right">
			<a href="#" class="button btn-modal-open" title="본 영화 등록">본 영화 등록</a>
		</div>
	</div>
	<div class="movie-list-util mt30 oneContent">
		<div class="movie-sorting">
			<span>
				<button type="button" class="btn sortBtn on">
				전체
					<em class="font-gblue">0</em>
				건
				</button>
			</span>
		</div>
		<div class="movie-sorting-right">
			<span>
				<button class="btn orderBtn on">최신순</button>
			</span>
			<span>
				<button class="btn orderBtn">공감순</button>
			</span>
			<span>
				<button class="btn orderBtn">평점순</button>
			</span>
		</div>
	</div>
        ...
        <ul>
            <li class="type03">
                <div class="story-area">
                    ...
                    <%if(loginId == null) { %>
                    <div class="user-prof">
                        <div class="prof-img"><img src="image/movie_info/ico-mega-profile.png" alt="MEGABOX"></div>
                        <p class="user-id">MEGABOX</p>
                    </div>
                    <% } else { %>
                    <!--  로그인 시 -->
                    <div class="user-prof">
                        <div class="prof-img"><img src="프로필 이미지" alt="MEGABOX"></div>
                    ...
                    <div class="story-box">
                        <div class="story-wrap">
                            <div class="story-cont">
                                <span class="font-gblue">스파이더맨: 노웨이 홈</span>재미있게 보셨나요? 영화의 어떤 점이 좋았는지 이야기해주세요.
                            </div>
                            <div class="story-write">
			                	 <!-- 로그인이 안되있을시 -->
                                	<a href="로그인페이지로" class="tooltip-click oneWrtNonMbBtn" w-data="500" h-data="680" data-cd="PREV" title="관람평쓰기"><i class="iconset ico-story-write"></i> 관람평쓰기</a>		                	    						
                            </div>
                        </div>
                    </div>
                    <!-- // 내용 영역 -->
            ...
            <li class="type01 oneContentTag">
            	<div class="story-area">
            		<div class="user-prof">
            			<div class="prof-img">
            				<img src="프로필사진" alt="프로필사진" title="프로필사진"/>
            			</div>
            			<p class="user-id">tor**<p>
            		</div>
            		<div class="story-box">
            			<div class="story-wrap review">
            				...
            				<div class="story-cont">
	            				...
	            				<div class="story-txt">
	            					저의 어린 시절부터 20대인 현재까지 모두 안아주는 영화였습니다.
	            				</div>
