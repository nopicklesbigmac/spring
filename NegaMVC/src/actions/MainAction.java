...
public class MainAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ArrayList<Integer> heartCount = wtwDao.countLike(listMain); 
		HashMap<String, Integer> hmapMovieCodeLike = wtwDao.countLikeMember(listMain, loginId); //session의 loginId
		...
		//reviewCount heartCount hmapMovieCodeLike를 main_page.jsp에 넘길 것.
