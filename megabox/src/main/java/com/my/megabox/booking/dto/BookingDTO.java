...
public class BookingDTO {
	...
	private String full_booking_date;
	...
	public String getFull_booking_date() {
		return full_booking_date;
	}
	public void setFull_booking_date(String full_booking_date) {
		this.full_booking_date = full_booking_date;
	}

	@Override
	public String toString() {
		return "BookingDTO [b_num=" + b_num + ", b_date=" + b_date + ", b_time=" + b_time + ", b_start=" + b_start
				+ ", b_end=" + b_end + ", b_fee=" + b_fee + ", b_seat=" + b_seat + ", b_s_cnt=" + b_s_cnt + ", c_num="
				+ c_num + ", s_num=" + s_num + ", m_num=" + m_num + ", u_num=" + u_num + "]";
	}
