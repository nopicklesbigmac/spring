		...
		<div class="container">
			...
			<div class="page-util">
				<div class="inner-wrap">
					<div class="location">
						<span>Home</span> <a href="${path}/list" title="극장 페이지로 이동">극장</a>
						<a href="${path}/list" title="전체극장 페이지로 이동">전체극장</a>
					</div>
				</div>
			</div>
						...
						<div
							...
							<div class="swiper-wrapper"
								...
								<div class="cell swiper-slide swiper-slide-active" tabindex="0"
									...
									<a href="#" class="eventBtn" data-no="22" data-netfunnel=""
											...
											<c:forEach var="cinema" items="${list }">
												<c:if test="${cinema.c_num < 20 }">
													<li data-brch-no="${cinema.c_num}"><a
														href="${path }/showCinema?cName=${cinema.c_name}"
