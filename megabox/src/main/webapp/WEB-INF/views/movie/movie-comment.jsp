...
$(document).ready(function(){
	...
	$("#layeropen > button").click(function(){
		alert("안녕");
...
function commenti(){
	alert("클릭");
					...
					<div class="inner-wrap pb100">
						<div class="tab-list fixed">
							<ul>
								<li><a href="movie-detail?rpstMovieNo=${movie.m_num }"
									title="주요정보 탭으로 이동">주요정보</a></li>
								<li class="on"><a href="movie-comment?rpstMovieNo=${movie.m_num }"
									title="실관람평 탭으로 이동">실관람평</a></li>
								<li><a href="movie-post?rpstMovieNo=${movie.m_num }"
									title="무비포스트 탭으로 이동">무비포스트</a></li>
								<li><a
									href="movie-trailer?rpstMovieNo=${movie.m_num }"
						...
						<!-- 한줄평 있을 때 -->
						<div class="tit-util mt40 oneContent">
							<h2 class="tit small">
								${movie.m_name } 대한 <span class="font-gblue">${fn:length(comment) }</span>개의 이야기가 있어요!
							</h2>
							<!-- <div class="right">
								<a href="#saw_movie_regi" class="button btn-modal-open"
									id="regBtn" w-data="600" h-data="470" title="본 영화 등록">본 영화
									등록</a>
							</div> -->
						</div>
						...
						<div class="movie-list-util mt30 oneContent">
							<div class="movie-sorting">
								<span><button type="button" class="btn sortBtn on"
										data-cd="">
										전체 <em class="font-gblue" id="cnt1">${fn:length(comment) }</em> 건
									</button></span>
							</div>
						...
						<!--<div class="movie-idv-story pb100 oneContent"> -->
						<div class="movie-idv-story">
										...
										<div class="story-box">
											<div class="story-wrap">
												<div class="story-cont">
													<span class="font-gblue">${movie.m_name}</span> 재미있게 보셨나요? 영화의 어떤
													점이 좋았는지 이야기해주세요.<br>  <span></span>
													<br>

												</div>

												<div id="layeropen" class="story-write"><!-- #tooltip-layer01 -->
													<!-- <button title="관람평쓰기" onclick="openlayer();"
														class="tooltip-click oneWrtNonMbBtn"><i
														class="iconset ico-story-write"></i >관람평쓰기</button> -->
													<button title="관람평쓰기"
													id="aclick" ><i
														class="iconset ico-story-write"></i >관람평쓰기</button>
								...
								<li class="type01 oneContentTag">
									<div class="story-area">
										<div class="user-prof">
											<div class="prof-img">
												<img
													src="${path }/resources/img/bg-photo.png"
													alt="프로필 사진" title="프로필 사진">
											</div>
											<p class="user-id">${comment.o_num }</p>
										</div>
										<div class="story-box">
											<div class="story-wrap review">
												...
												<div class="story-cont">
													<div class="story-point">
														<span>${comment.o_avg }</span>
													</div>
													<div class="story-recommend">
														<em>${comment.o_point }</em>
													</div>
													<div class="story-txt">${comment.o_content }</div>
													<div class="story-like">
														<button type="button" class="oneLikeBtn" title="댓글 추천"
															data-no="1716590" data-is="N" data-cd="PREV">
							...
							<!-- 페이지
								...
								<strong class="active">1</strong> <a title="2페이지보기"
									...
									class="control next" pagenum="11">next</a> <a
									title="마지막 페이지 보기" href="javascript:void(0)"
									class="control last" pagenum="3620">last</a>
							</nav> -->
						</div>
						<!-- movie-idv-story -->
					</div>
...
<section id="layer_regi_reply_review" class="modal-layer" style="z-index: 506;">
    <div class="wrap" style="width: 500px; height: 680px; margin-left: -250px; margin-top: -340px;">
            ...
            <div class="regi-reply-score review">
                ...
                <div class="score">
                    ...
                    <div class="box">
                        ...
                        <div class="textarea">
                            <textarea  maxlength="100" id="textarea" 
                            rows="5" cols="30" title="한줄평 입력" placeholder="실관람평을 남겨주세요." class="input-textarea"></textarea>
                            <div class="util">
                                <p class="count">
                                  <!--   <span>0</span> / 100 -->
                                </p>
                ...
                <div class="point">
                    ...
                    <p class="txt" id="oneLineAlert">(최대 2개 선택가능)</p>
        ...
        <div class="btn-group-fixed">
            ...
            <button type="button" class="button purple" id="regOneBtn" data-no="" data-cd="PREV" data-mno="20053200">등록</button>
        </div>
