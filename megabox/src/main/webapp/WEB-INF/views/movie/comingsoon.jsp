			...
			<div id="contents" class="">
				...
				<div class="inner-wrap">
					...
					<div class="tab-list fixed">
						<ul id="topMenu">
							<li><a href="${path }/movie" title="박스오피스 탭으로 이동">박스오피스</a></li>
							<li class="on"><a href="${path}/movie/comingsoon" title="상영예정작 탭으로 이동">상영예정작</a></li>
                        ...
                        document.write(str);
                           ...
                           <div class="btn-util">
                              <button type="button" class="button btn-like"
                                 data-no="${list.m_num}">
                                 <i title="보고싶어 안함"
                                    class="iconset ico-heart-toggle-gray intrstType"></i> <span>${list.m_like }</span>
                              </button>
                              <%-- 
                              좋아요 눌렀을때 태그 
                              <button type="button" class="button btn-like"
                              ...
                              <div class="case col-2 movieStat3" style="display: none">
                                 <a href="#" class="button purple bokdBtn" data-no="${list.m_num}"
                              ...
                              <div class="case movieStat4" style=""></div></div></li>
