...
function setTab( idx ){
    switch( idx ) {
        default :
            url 	= location.protocol + "//" + document.domain + "/movie-detail?detailrpstMovieNo=${movie.m_num}";
            metaFormat = {
...
<%-- 							<button type="button" title="보고싶어 안함" class="btn btn-like"
								rpst-movie-no="${movie.m_num }">
								<i class="iconset ico-heart-line"></i> <span title="보고싶어 한 명수"
									id="intrstCnt"> ${movie.m_like } </span>
							</button>
							 --%>
							<c:choose>
                              <c:when test="${map[movie.m_num]==true}">
                              <button type="button" class="btn btn-like on"
                                 data-no="${movie.m_num}" data-type="on"> <!-- 좋아요 on / 안하면 off -->
                                 <i class="iconset ico-heart-line"></i> <span title="보고싶어 한 명수"
									id="intrstCnt"> ${movie.m_like } </span>
                              </button></c:when>
                              <c:otherwise>
                              <button type="button" class="btn btn-like"
                                 data-no="${movie.m_num}" data-type="off"> <!-- 좋아요 on / 안하면 off -->
                                <i class="iconset ico-heart-line"></i> <span title="보고싶어 한 명수"
									id="intrstCnt"> ${movie.m_like } </span>
                              </button>
                              </c:otherwise>
						...
						<div class="info">
							<c:if test="${movie.m_avg!=0 and movie.m_avg !=null }">
								<div class="score">
					...
					<p title="관람 후 점수" class="after"><em>7.9</em><span class="ir">점</span></p> -->
								...
								</script> -->${movie.m_avgstr }</em><span class="ir">점</span>
										</p>
						...
						<div class="poster">
							<div class="wrap">
								...
								<img src="${movie.m_poster }" onerror="noImg(this)"
									alt="${movie.m_name}"> <a href="#"
...
window.onload = function(){
   var traril = '${movie.m_trailer }';
   var trariler = traril.split('=');
   var  url = 'https://www.youtube.com/embed/'+ trariler[1];
					...
					<div class="inner-wrap">
						<div>
							<div class="tab-list fixed">
								<ul>
									<li class="on"><a
										href="movie-detail?rpstMovieNo=${movie.m_num }"
										title="주요정보 탭으로 이동">주요정보</a></li>
									<li><a href="movie-comment?rpstMovieNo=${movie.m_num }"
										title="실관람평 탭으로 이동">실관람평</a></li>
									<li><a href="movie-post?rpstMovieNo=${movie.m_num }"
										title="무비포스트 탭으로 이동">무비포스트</a></li>
									<li><a href="movie-trailer?rpstMovieNo=${movie.m_num }"
							...
							<div class="movie-summary infoContent" id="info">
								...
								<div class="txt">${movie.m_story }</div>
							...
							<div class="movie-info infoContent">
								<p>상영타입 : ${movie.m_type}</p>

								<div class="line">
									<p>감독&nbsp;: ${movie.m_director }</p>
									<p>장르&nbsp;: 드라마 / ${movie.m_r_time} 분</p>
									<p>등급&nbsp;: ${movie.m_age }세이상관람가</p>
									<p>개봉일&nbsp;: ${movie.m_date}</p>
									<!--          <p>배급사 : &#40;주&#41;쇼박스</p> -->
								</div>
								<p>출연진&nbsp;: ${movie.m_actor }</p>
							</div>
							...
							<div class="movie-graph infoContent">
								...
								<div class="col" id="subMegaScore">
									...
									<div class="graph" style="display: none;">
										<img src="../../../static/pc/images/movie/no-graph02.jpg"
											alt="메가스코어 결과 없음">
									</div>
								...
								<div class="col">
									<dl>
										<dt>누적관객수</dt>
										<dd class="font-roboto regular">${movie.m_attendancestr}</dd>
									</dl>
							...
							<h2 class="tit small">
								${movie.m_name}에 대한 <span class="font-gblue">3,200</span>개의 이야기가 있어요!
							</h2>
						</div>
								...
								<div class="layer-con">
									...
									<div class="pop-gray mt10 mb30">
										<label for="movie_regi" class="mr10">거래번호 또는 예매번호</label> <input
											type="text" id="movie_regi" class="input-text w280px"
...
<!-- 로그인이 안되있을시 -->
                              ...
                              <div class="story-box">
                                 <div class="story-wrap">
                                    <div class="story-cont">
                                       <span class="font-gblue">${movie.m_name}</span> 재미있게 보셨나요? 영화의 어떤 점이
                                       좋았는지 이야기해주세요.
                                    </div>
                        ...
                        <li class="type01 oneContentTag">
                           <div class="story-area">
                              <div class="user-prof">
                                 <div class="prof-img">
                                    <img src="${path }/resources/img/bg-photo.png"
                                       alt="프로필 사진" title="프로필 사진" onerror="noImg(this, 'human')">
                                 </div>
                                 <p class="user-id">ok3799**</p>
                              </div>
                              <div class="story-box">
                                 <div class="story-wrap review">
                                    ...
                                    <div class="story-cont">
                                       ...
                                       <div class="story-txt">스토리 너무 좋아요~지루하지 않고 재미나요</div>
                                       <div class="story-like">
                                          <button type="button" class="oneLikeBtn" title="댓글 추천"
                                             data-no="1670215" data-is="N">
					...
					<div class="movie-detail-poster mt70 moviepostContent">
						<div class="inner-wrap">
							...
							<div class="tit-util mb15">
								...
								<a href="#" id="goMoviePost" class="more" data-nm="${movie.m_name}"
									...
									<div class="wrap">
										...
										<div class="img">
											<a href="#layer_post_detail" title="무비포스트 상세보기"
												class="moviePostBtn btn-modal-open2" w-data="850"
												h-data="auto" data-no="210463"><img
												src="https://img.megabox.co.kr/SharedImg/2021/11/19/sYxGqpE8PyC3SCvDjEIZakS92flSvnRn_230.jpg"
												onerror="noImg(this)" alt="${movie.m_name}"></a>
										</div>
										...
										<div class="cont">
											<div class="writer">
												...
												<a href="#" title="무비포스트 페이지로 이동" class="moviePostId"
													data-id="61263544-42C8-4C65-A3F2-E37EF648A66E">choae10**</a>

											</div>

											<a href="#layer_post_detail" title="무비포스트 상세보기"
												class="link moviePostBtn btn-modal-open2" w-data="850"
												h-data="auto" data-no="210463">
												<div class="label"></div>

												<p class="tit">${movie.m_name}</p>
												<p class="txt">대부분의 혹평 때문에 안볼려다가 봤는데 저는 재미있었어요!</p>
												<p class="time">44 분전</p>
											</a>
					...
					<div class="inner-wrap mt70 infoContent">
						<div class="tit-util mb15">
							...
							<a href="javascript:void(0)" title="이벤트 페이지로 이동"
								onclick="NetfunnelChk.aTag('EVENT_LIST','/event');return false;"
								class="more">더보기 <i class="iconset ico-arr-right-gray"></i></a>
						</div>
						...
						<div class="event-box">
							<ul>
								...
								<li><a href="#" title="[${movie.m_name}]앵콜! 선착순 빵원티켓 ➕ 상세보기"
									class="eventBtn" data-no="11660" data-netfunnel="N"><img
										src="https://img.megabox.co.kr/SharedImg/event/2022/08/03/xt1SqJ0xDRBJIIh4CyucLBK5Ulw2bxAA.jpg"
										onerror="noImg(this)" alt="[${movie.m_name}]앵콜! 선착순 빵원티켓 ➕"></a></li>



								<li><a href="#"
									title="&lt;한산: 용의 출현 &gt; 100점 위인의 축복! 100P 럭키코인🎁 상세보기"
									class="eventBtn" data-no="11658" data-netfunnel="N"><img
										src="https://img.megabox.co.kr/SharedImg/event/2022/08/02/gBd3SDtedYbpieDohgAjwNaWAf5BBU2K.jpg"
										onerror="noImg(this)"
										alt="&lt;한산: 용의 출현 &gt; 100점 위인의 축복! 100P 럭키코인🎁"></a></li>
						...
						<div class="wrap">
							...
							<div class="btn-group-fixed">
								...
								<button type="button" class="button purple" id="regOneBtn"
									data-no="" data-cd="" data-mno="21084100">등록</button>
							</div>
