...
<input type="hidden" id="playDe" name="playDe" value="">
    ...
    <div id="bokdMSeat" style="overflow:hidden; display:none; height:736px;" class="">
    ...
    <div id="bokdMPayBooking" style="overflow:hidden; display:none; height:736px;" class="">
							...
							<ul class="area-depth1">
								...
								<li><a href="" class="depth1" title="서울 선택">서울</a>
									<div class="area-depth2">
										<ul>
											<c:forEach var="c" items="${applicationScope.sList.get('서울') }">
								...
								<li><a href="" class="depth1" title="경기 선택">경기</a>
									<div class="area-depth2">
										<ul>
											<c:forEach var="c" items="${applicationScope.sList.get('경기') }">
											<li class="" onclick="location.href='showCinema?cName=${c}'">
											<a title="${c } 상세보기">${c}</a></li>
											</c:forEach>
										</ul>
								...
								<li><a href="" class="depth1" title="인천 선택">인천</a>
									<div class="area-depth2">
										<ul>
											<c:forEach var="c" items="${applicationScope.sList.get('인천') }">
											<li class="" onclick="location.href='showCinema?cName=${c}'">
											<a title="${c } 상세보기">${c}</a></li>
											</c:forEach>
										</ul>
								...
								<div class="area-depth2">
										<ul>
											<c:forEach var="c" items="${applicationScope.sList.get('대전') }">
											<li class="" onclick="location.href='showCinema?cName=${c}'">
											<a title="${c } 상세보기">${c}</a></li>
											</c:forEach>
										</ul>
								...
								<li class=""><a href="" class="depth1" title="부산/대구/경상 선택">부산/대구/경상</a>
									<div class="area-depth2">
										<ul>
											<c:forEach var="c" items="${applicationScope.sList.get('부산') }">
											<li class="" onclick="location.href='showCinema?cName=${c}'">
											<a title="${c } 상세보기">${c}</a></li>
											</c:forEach>
										</ul>
								...
								<li><a href="" class="depth1" title="광주/전라 선택">광주/전라</a>
									<div class="area-depth2">
										<ul>
											<c:forEach var="c" items="${applicationScope.sList.get('광주') }">
											<li class="" onclick="location.href='showCinema?cName=${c}'">
											<a title="${c } 상세보기">${c}</a></li>
											</c:forEach>
										</ul>
								...
								<li><a href="" class="depth1" title="강원 선택">강원</a>
									<div class="area-depth2">
										<ul>
											<c:forEach var="c" items="${applicationScope.sList.get('강원') }">
											<li class="" onclick="location.href='showCinema?cName=${c}'">
											<a title="${c } 상세보기">${c}</a></li>
											</c:forEach>
										</ul>
		...
		<div class="inner-wrap pt40">
			...
			<div class="tab-list fixed mb40 tab-layer">
				<ul>
					...
					<li><a href="" onclick="location.href='showCinemaTimetable?cName=${cinema.c_name }'" title="상영시간표 탭으로 이동">상영시간표</a></li>
...
<div class="location-map-btn mt15">
	<div class="btn-group left">
		<a href="https://m.map.naver.com/search2/search.naver?query=${cinema.c_state } ${cinema.c_city } ${cinema.c_detail }" class="button purple" target="_blank" title="새창열림">실시간 길찾기</a>
	</div>
</div>
<!--// location-info -->
