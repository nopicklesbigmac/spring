<%@page import="com.my.megabox.common.dto.AllDTO"%>
...
$(document).ready(function(){
	...
	var c = '<c:out value="${cName}"/>';
	
	var param = {"cName": c, "day": clickedDay};
	param = JSON.stringify(param);
	
	$.ajax({
		url: 'sendCinemaAndDate', 
		type: 'post', 
		data: param,  
			...
			<div id="contents" class="no-padding">
				...
				<div class="inner-wrap pt40">
					...
					<div class="tab-list fixed mb40 tab-layer">
						<ul>
							<li class=""><a href="#tab01" onclick="location.href='showCinema?cName=${cName}'" title="극장정보 탭으로 이동">극장정보</a></li>
										...
										<div class="wrap"
											...
											<c:forEach var="d" items="${applicationScope.dList }"> 
												<button onclick="click_date(this);" name="actual_date"
													class="" type="button" value="${d.year }.${d.month }.${d.date }" month="${d.month }"
													tabindex="-1">
