...
<div id="contents" class="">
	...
	<div class="tab-cont-wrap">
		...
		<div id="myBokdArea" class="tab-cont on"><a href="" class="ir">예매  탭 화면 입니다.</a>
			...
			<c:choose>
			<c:when test="${empty ymList}">
				<div id="bokdList"><div class="no-history-reservation mt20">	예매 내역이 없습니다. </div></div>
			</c:when>
			<c:otherwise>
			<div class="board-list-util">	
					<p class="result-count pt00"><strong>총<b class="font-gblue">${ymList.size() }</b>건</strong>	</p>
			</div>
						...
						<li>	
							<div class="round">		
								<a href="#" class="img" title="${uYM.m_name }">
									<img src="${uYM.m_poster }" alt="${uYM.m_name }" width="135" height="194">
								</a>
								<table class="table">			
									<colgroup>				
										<col style="width:75px;">				
