		...
		<div class="my-magabox-info ">
			...
			<div class="top">
				<div class="photo" id="myPhoto">
					<div class="wrap">
                     ...
                     <c:when test="${userImage == null }">
                        ...
                        <a href="MyInfo?id=${sessionScope.loginId}">
                        <button type="button" class="img">
                        <img src="${path}/resources/image/bg-photo.png">
                        </button>
                        </a>
                     </c:when>
                     <c:otherwise>
				...
				<div class="grade">
					...
					<div class="link">
						<a href="MyInfo?id=${sessionScope.loginId}" title="개인정보수정 페이지로 이동">개인정보수정 <i class="iconset ico-arr-right-reverse"></i></a>
									...
									<ul>
										<li>	
											<div class="round">		
												...
												<a href="" class="button gray" title="예매취소"  onclick="cancelCheck(${uYM.b_num })">예매취소</a>		
												</div>	
											</div>
										</li>
									</ul>
		...
		<div id="myPurc">
			...
			<div class="table-wrap">
				<table class="board-list line" summary="나의 구매내역 요약 표">
					...
					<c:if test="${movieList == null || empty movieList }">
						<tr><td colspan="5" class="a-c">구매내역이 없습니다.</td></tr>
					</c:if>
					</tbody>
				</table>
			</div>
			...
			<div class="myPurc">
				...
				<div class="brd-list">
					<ul>
						...
						<c:if test="${iqList != null }">
							<c:forEach var="list" items="${iqList }">
								<li>	
								<a href="detailIQ?i_num=${list.i_num }" class="link" title="${list.i_title } 상세보기">		
								<p class="cate">			
								<em>1:1문의</em>			
								<span>${list.i_date }</span>		
								</p>		
								<p class="tit">${list.i_title }</p>	
								</a>
								<span class="answer done">대기중</span>
								</li>
							</c:forEach>
						</c:if>
					</ul>
