					...
					<div>
						<div class="tab-list fixed">
							<ul>
								...
								<li><a href="movie-trailer?rpstMovieNo=1"
                     ...
                     <script>
                      window.onload = function(){
                        ...
                        <div class="swiper-slide swiper-slide-active" style="width: 800px; opacity: 1; transform: translate3d(0px, 0px, 0px);"><div class="vsc-controller"></div>
                           ...
                           <iframe id="my_frame" width="800" height="400" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                  </div>
