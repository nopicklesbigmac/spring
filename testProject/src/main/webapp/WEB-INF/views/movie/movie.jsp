...
<!-- 영화정보 자리  -->
						<c:forEach var="list" items="${list }" varStatus="status">
							<li tabindex="0" class="no-img"><div class="movie-list-info">
									<p class="rank" style="">
										<c:out value="${status.count}" /><span class="ir">위</span>
									</p>
									<img
										src="${list.m_poster }"
										alt="${list.m_name }" class="poster lozad" onerror="noImg(this)">
									<div class="curation">
									...
									<div class="movie-score">
										<a href="movie-detail?rpstMovieNo=${list.m_num }" class="wrap movieBtn" data-no="${list.m_num }"
								...
								<div class="rate-date">
									<span class="rate"><!-- 예매율  --></span> <span class="date">개봉일
										${list.m_date }</span>
								</div>
								<div class="btn-util">
									...
									<div class="case col-2 movieStat3" style="display: none">
										<a href="#" class="button purple bokdBtn" data-no="21084100"
											title="영화 예매하기">예매</a> <a href="#"
											class="button purple img splBtn" data-no="21084100"><img
