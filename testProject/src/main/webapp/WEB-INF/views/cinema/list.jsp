...
<script
	src="//cast.imp.joins.com/head/jPfCCh8tg1_Ef0ws5eBgkXfnqZnnRiRBtc-1kUGVmrmEAM4qWzAZAbZXeTd0VUJUOFJtV3JVWGlQbEZqaE5BAstB2Lie5Z8K6wPLQdi4nuWfCus.js?url=https%3A%2F%2Fwww.megabox.co.kr%2Ftheater%2Flist&amp;ref=https%3A%2F%2Fwww.megabox.co.kr%2F"></script>
						...
						<div class="left">
							...
							<div class="swiper-control">
								...
								<div class="theater-util">
									<button type="button"
										class="theater-prev swiper-button-disabled" tabindex="0"
										role="button" aria-label="Previous slide" aria-disabled="true">이전
										이벤트 보기</button>
									<button type="button"
										class="theater-next swiper-button-disabled" tabindex="0"
						...
						<div
							...
							<div class="swiper-wrapper"
								...
								<div class="cell swiper-slide swiper-slide-active" tabindex="0"
									...
									<a href="#" class="eventBtn" data-no="11524" data-netfunnel=""
										title="[광명소하지점] 오픈 이벤트 상세보기">
								...
								<div class="cell swiper-slide swiper-slide-next" tabindex="0"
									style="width: 245px; margin-right: 40px;">
									<a href="#" class="eventBtn" data-no="11531" data-netfunnel=""
										title="[금정AK플라자지점] 오픈 이벤트 상세보기">
				...
				<div class="inner-wrap">
							...
							<ul>
									...
									<div class="theater-list">
										<ul>
											<c:forEach var="cinema" items="${list }">
												<c:if test="${cinema.c_num < 20 }">
													<li data-brch-no="${cinema.c_num}"><a
														href="${path }//theater?brchNo=${cinema.c_num}"
														title="${cinema.c_name} 상세보기">${cinema.c_name}</a></li>
												</c:if>
											</c:forEach>
								...
								<li>
									...
									<div class="theater-list">
										<ul>
											<c:forEach var="cinema" items="${list }">
												<c:if test="${cinema.c_num >= 51 }">
													<c:if test="${cinema.c_num <= 55 }">
														<li data-brch-no="${cinema.c_num}"><a
															href="${path }//theater?brchNo=${cinema.c_num}"
															title="${cinema.c_name} 상세보기">${cinema.c_name}</a></li>
													</c:if>
								...
								<li>
									...
									<div class="theater-list">
										<ul>
											<c:forEach var="cinema" items="${list }">
												<c:if test="${cinema.c_num >= 56 }">
													<c:if test="${cinema.c_num <= 72 }">
														<li data-brch-no="${cinema.c_num}"><a
															href="${path }//theater?brchNo=${cinema.c_num}"
															title="${cinema.c_name} 상세보기">${cinema.c_name}</a></li>
													</c:if>
								...
								<li>
									...
									<div class="theater-list">
										<ul>
											<c:forEach var="cinema" items="${list }">
												<c:if test="${cinema.c_num >= 73 }">
													<c:if test="${cinema.c_num <= 94 }">
														<li data-brch-no="${cinema.c_num}"><a
															href="${path }//theater?brchNo=${cinema.c_num}"
															title="${cinema.c_name} 상세보기">${cinema.c_name}</a></li>
													</c:if>
								...
								<li>
									...
									<div class="theater-list">
										<ul>
											<c:forEach var="cinema" items="${list }">
												<c:if test="${cinema.c_num >= 95 }">
													<c:if test="${cinema.c_num <= 103 }">
														<li data-brch-no="${cinema.c_num}"><a
															href="${path }//theater?brchNo=${cinema.c_num}"
															title="${cinema.c_name} 상세보기">${cinema.c_name}</a></li>
													</c:if>
								...
								<li>
									<button type="button" class="sel-city">강원${path }</button>

									<div class="theater-list">
										<ul>
											<c:forEach var="cinema" items="${list }">
												<c:if test="${cinema.c_num >= 104 }">
													<c:if test="${cinema.c_num <= 108 }">
														<li data-brch-no="${cinema.c_num}"><a
															href="${path }/theater?brchNo=${cinema.c_num}"
															title="${cinema.c_name} 상세보기">${cinema.c_name}</a></li>
													</c:if>
					...
					<div class="event-box">
						<ul>
							...
							<li><a href="#" class="eventBtn" data-no="11634"
								data-netfunnel="N" title="[세종(조치원)] 당신의 마음을 스크린에 담아보세요! 상세보기">
									<img
									src="https://img.megabox.co.kr/SharedImg/event/2022/07/28/KpFvxFcioqWMjiW5ODY8x8ry4BwgqYqt.jpg"
									alt="[세종(조치원)] 당신의 마음을 스크린에 담아보세요!" onerror="noImg(this)">
							</a></li>

							<li><a href="#" class="eventBtn" data-no="11633"
								data-netfunnel="N" title="[광명소하] 광명소하 보드카페 OPEN! 상세보기"> <img
									src="https://img.megabox.co.kr/SharedImg/event/2022/07/28/c0KJOHLJlBxmGYmIVzMDXQZNfbDA9GhI.jpg"
									alt="[광명소하] 광명소하 보드카페 OPEN!" onerror="noImg(this)">
							</a></li>
						...
						<table class="board-list">
							...
							<tbody>
								...
								<tr>
									<td>춘천석사</td>
									<th scope="row"><a
										href="/support/notice/detail?artiNo=10637&amp;bbsNo=9"
										title="[춘천석사] 7월 31일 장비 오작동으로 인한 상영중단 및 취소 안내  상세보기">
											[춘천석사] 7월 31일 장비 오작동으로 인한 상영중단 및 취소 안내 </a></th>
									<td>강원</td>
									<td>2022.08.01</td>
								</tr>
								...
								<tr>
									<td>코엑스</td>
									<th scope="row"><a
										href="/support/notice/detail?artiNo=10633&amp;bbsNo=9"
										title="[코엑스] 8/2 <헌트> 시사회 진행에 따른 고객 안내문 상세보기"> [코엑스] 8/2
											&lt;헌트&gt; 시사회 진행에 따른 고객 안내문 </a></th>
									<td>서울</td>
									<td>2022.07.25</td>
								</tr>
								...
								<tr>
									<td>신촌</td>
									<th scope="row"><a
										href="/support/notice/detail?artiNo=10632&amp;bbsNo=9"
										title="[신촌] We are TURNS! ENCORE 예매 안내 상세보기"> [신촌] We are
											TURNS! ENCORE 예매 안내 </a></th>
									<td>서울</td>
									<td>2022.07.19</td>
								</tr>
								...
								<tr>
									<td>코엑스</td>
									<th scope="row"><a
										href="/support/notice/detail?artiNo=10631&amp;bbsNo=9"
										title="[코엑스] 7/25 <비상선언> 시사회 진행에 따른 이용 안내 상세보기"> [코엑스]
											7/25 &lt;비상선언&gt; 시사회 진행에 따른 이용 안내 </a></th>
									<td>서울</td>
									<td>2022.07.18</td>
								</tr>
								...
								<tr>
									<td>대전신세계 아트앤사이언스</td>
									<th scope="row"><a
										href="/support/notice/detail?artiNo=10630&amp;bbsNo=9"
										title="[대전신세계 아트앤사이언스] 영화관 방문 고객 지하주차장 이용 안내(07/18) 상세보기">
											[대전신세계 아트앤사이언스] 영화관 방문 고객 지하주차장 이용 안내(07/18) </a></th>
									<td>대전/충청/세종</td>
									<td>2022.07.18</td>
								</tr>
