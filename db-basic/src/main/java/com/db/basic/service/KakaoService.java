...
public class KakaoService {
	public String getAccessToken(String code) {
		...
		try {
			String sendMessage = "grant_type=authorization_code" + "&client_id=28bad6b03de5ed8d1160a733b0e0e5c9"
...
/*
  {
  "id":2346557759,
  "connected_at":"2022-07-18T10:58:52Z",
  "properties":{"nickname":"김준형"},
  "kakao_account":{
  		"profile_nickname_needs_agreement":false,
  		"profile":{"nickname":"김준형"},
  		"has_email":true,
  		"email_needs_agreement":false,
  		"is_email_valid":true,
  		"is_email_verified":true,
  		"email":"zxc777a@naver.com"
  		}
  }
 */
	        JsonElement element = JsonParser.parseString(result);
...
//	        String nickname = properties.getAsJsonObject().get("nickname").getAsString();
	...
	public void logout2() {
		...
		URL url;
		 ...
		 params.append("client_id=" + "28bad6b03de5ed8d1160a733b0e0e5c9");
